...
public class Driver {
    ...
    public static void testCaptureRule() {
        ...
        // set up capture:
        // last stone will land on empty bucket 2
        m.getBuckets()[2] = 0;
        m.getBuckets()[9] = 3; // opposite bucket
        m.getBuckets()[1] = 1; // the move
        ...
        System.out.println(m);
        System.out.println("Box1 should have 4 stones: " + m.getBox1());
    }
    ...
    public static void testGameOverSweep() {
        ...
        m.makeMove(7); // triggers sweep

        System.out.println(m);
        System.out.println("Box2 should have +5: " + m.getBox2());
    }
